<div class="col-12">
    ...
    <div class="form-group w-100 filepond-container">
        <label for="horizontalImg960" class=font-weight-bold">Изображение 960×160 (1920×320 x2)</label>
    ...
    <div class="form-group w-100 filepond-container">
        <label for="horizontalImg768" class=font-weight-bold">Изображение 768×160 (1536×320 x2)</label>
    ...
    <div class="form-group w-100 filepond-container">
        <label for="horizontalImg375" class=font-weight-bold">Изображение 375×160 (750×320 x2)</label>
