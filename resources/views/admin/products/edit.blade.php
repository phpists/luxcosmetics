...
{{--                                                        @endforeach--}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                ...
                                                <input type="number" step="any" name="price" value="{{$product->raw_price}}" class="form-control"/>
                                            </div>
                                            <div class="col-md-1">
                                                <label for="exampleSelect2">Старая цена</label>
                                                <input type="number" step="any" name="old_price" value="{{$product->raw_old_price}}" class="form-control"/>
                                            </div>
                                            <div class="col-md-1">
                                                <label for="exampleSelect2">РРЦ</label>
                                                <input type="number" name="rrp" value="{{ $product->rrp }}" class="form-control" required/>
                                            </div>
                                            <div class="col-md-1">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="lengthField" name="length_product" value="{{ $product->length_product }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="widthField">Ширина:</label>
                                            <input type="number" class="form-control" id="widthField" name="width_product" value="{{ $product->width_product }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="heightField">Высота:</label>
                                            <input type="number" class="form-control" id="heightField" name="height_product" value="{{ $product->height_product }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="weightField">Вес:</label>
                                            <input type="number" class="form-control" id="weightField" name="weight_product" value="{{ $product->weight_product }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
