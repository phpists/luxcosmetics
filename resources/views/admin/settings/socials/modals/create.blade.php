                    ...
                    <div class="row row-cols-1 row-cols-md-2">
                        <div class="col">
                            <div class="form-group row mb-0">
                                <label class="col-auto col-form-label" for="createIsActiveInContacts">Страница "Контакты"</label>
                                <div class="col-3">
                                    <span class="switch">
                                        <label>
                        ...
                        <div class="col">
                            <div class="form-group row mb-0">
                                <label class="col-auto col-form-label" for="createIsActiveInFooter">Активная в футере</label>
                                <div class="col-3">
                                    <span class="switch">
                                        <label>
