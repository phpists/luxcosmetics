    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-1 mr-5">Cтатьи</h5>
                <!--end::Page Title-->
            </div>
            <!--end::Page Heading-->
        </div>
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container-fluid">
                <div class="card gutter-b col-lg-12 ml-0">
                    @include('admin.article.parts.filter')
                </div>
                @include('admin.layouts.includes.messages')
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Cтатьи</h3>
                        </div>
                    ...
                    <div class="card-body pb-3">
                            ...
                            <table class="table table-head-custom table-vertical-center">
                                ...
                                <tbody id="table">
                                    ...
                                    <tr id="post_{{$item->id}}" data-id="{{ $item->id }}">
                                        ...
                                        <td class="text-center pr-0">
                                            <div class="article__image"><a href="{{ route('index.article', $item->id) }}"><img src="{{asset('images/uploads/article/' . $item->image)}}" alt="" style=" width: 100px;"></a></div> 
                                        </td>
                                        <td class="text-center pr-0">
                                            <a href="{{ route('admin.article.edit', $item->id) }}" class="btn btn-sm btn-clean btn-icon">
                                                <i class="las la-edit"></i>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="{{ route('admin.article.delete', $item->id) }}" class="btn btn-sm btn-clean btn-icon" onclick="return confirm('Ви впевнені, що хочете видалити цей запис?')">
                                                <i class="las la-trash"></i>
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div id="pagination">
                            {{ $article->appends(request()->all())->links('vendor.pagination.product_pagination') }}
                        </div>
                        <!--end::Table-->
                    </div>
                </div>
...
@section('js_after')
    ...
    <script src="{{ asset('super_admin/js/article.js') }}"></script>
