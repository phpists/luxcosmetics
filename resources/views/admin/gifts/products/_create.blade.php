    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createGiftProductModalTitle">Добавить подарочный товар</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-12">
                            <div class="form-group w-100">
                                ...
                                <input type="number" class="form-control" id="createGiftProductPieces" name="pieces" min="0" required>
                            </div>
                        </div>
                    </div>
