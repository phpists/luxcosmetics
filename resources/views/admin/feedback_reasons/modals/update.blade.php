...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalTitle"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.feedback-reason.update')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                ...
                                <div class="col">
                                    <div class="col">
                                        <div class="form-group w-100">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="updateReason" name="reason" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
