                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="kt_tab_pane_1_4" role="tabpanel"
                            ...
                            <form id="form1" action="{{ route('admin.blog.update') }}" method="POST"
                        ...
                        <div class="tab-pane fade" id="kt_tab_pane_2_8" role="tabpanel"
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-auto ml-2">
                                    <div class="image-input image-input-outline" id="createImagePlugin" style="background-image: url('{{ asset('uploads/blog/' . $item->image) }}')">
