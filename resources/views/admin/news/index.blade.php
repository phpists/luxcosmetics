                                    ...
                                    <tr id="post_{{$item->id}}" data-id="{{ $item->id }}">
                                        ...
                                        <td class="text-center pr-0">
                                            ...
                                            <a href="{{ route('admin.news.edit', $item->id) }}" class="btn btn-sm btn-clean btn-icon">
                                                ...
                                                <a target="_blank" href="{{route('news.post', $item->link)}}">
                                            ...
                                            @endif
                                                @if(auth()->user()->isSuperAdmin() || auth()->user()->can(\App\Services\Admin\PermissionService::NEWS_DELETE))
                                            <a href="{{ route('admin.news.delete', $item->id) }}" class="btn btn-sm btn-clean btn-icon" onclick="return confirm('Вы уверенны, что хотите удалить данную запись?')">
                                                <i class="las la-trash"></i>
                                            </a>
                                                @endif
                                        </td>
