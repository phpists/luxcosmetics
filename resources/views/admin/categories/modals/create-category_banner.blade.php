...
<div class="modal fade" id="createCategoryBannerModal" tabindex="-1" role="dialog" aria-labelledby="createTagModal"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.category_banner.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group d-flex justify-content-center">
                                <select id="category_banner_create_select" name="banner_id" class="select2 form-control">
