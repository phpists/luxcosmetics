        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.category_post.edit', $post->id) }}" class="text-muted">Обновить пост</a>
                    </li>
                </ul>                <!--end::Page Title-->
            </div>
            <!--end::Page Heading-->
                            ...
                            <div class="form-group col">
                                <div class="col-auto ml-2">
                                    <div class="image-input image-input-outline" id="createImagePlugin">
                                        <div class="image-input-wrapper" id="updateImageBackground" style="background: url('{{asset('/images/uploads/category_posts/'.$post->image_path)}}')"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$post->link}}" name="link" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control status" name="is_active">
                                        <option @if($post->is_active === '1') selected @endif value="1">Активный</option>
                                        <option @if($post->is_active === '0') selected @endif value="0">Неактивный</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div style="max-height: 400px; overflow-y: auto;">
                                    <textarea id="textEditor" name="content">{{$post->content}}</textarea>
                                </div>
                            </div>
                        </div>
                    </form>
