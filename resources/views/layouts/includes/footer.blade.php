...
<footer class="footer">
    <div class="container">
        <div class="footer__top">
            <div class="footer__contacts">
                <div class="footer__logo"><img src="images/logo2.svg" alt=""></div>
                <div class="footer__wrap"><a class="footer__phone" href="tel:+74954779888">+7(495) 477-9-888</a>
                    <div class="footer__time">
                        Поддержка клиентов<br> c 9:00 до 20:00 без выходных
                    </div>
                    <div class="footer__msgs"><a class="footer__msg" href="" target="_blank">
                            <svg>
                                <use xlink:href="./images/sprite.svg#whatsapp"></use>
                            </svg>
                            Whatsapp</a><a class="footer__msg" href="" target="_blank">
                            <svg>
            ...
            <div class="footer__menublock">
                ...
                <div class="footer__menuitem">
                    ...
                    <ul class="footer__menu">
                        ...
                        <li><a href="">Для предложений по ассортименту</a></li>
                        <li><a href="">Партнерская программа</a></li>
                        <li><a href="">Общие контакты</a></li>
                        <li><a href="">Отдел маркетинга и рекламы</a></li>
                        <li><a href="">Для предложений</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="footer__bottom">
            <div class="footer__social f-social"><a class="f-social__item" href="">
                    <svg>
                        <use xlink:href="./images/sprite.svg#vk2"></use>
                    </svg>
                </a><a class="f-social__item" href="">
                    <svg>
                        <use xlink:href="./images/sprite.svg#youtube"></use>
                    </svg>
                </a><a class="f-social__item" href="">
                    <svg>
                        <use xlink:href="./images/sprite.svg#tg2"></use>
                    </svg>
                </a></div>
            <div class="footer__copyright">Luxe cosmetics © 2025 Все права защищены</div>
            <div class="footer__paymethods"><img src="images/visa.svg" alt=""><img src="images/mir.svg" alt="">
            </div>
        </div>
    </div>
</footer>
