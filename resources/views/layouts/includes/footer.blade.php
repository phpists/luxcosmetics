            ...
            <div class="col-lg-3 col-md-8 col-sm-8 col-6 collogo">
                ...
                <div class="footer__social social">
                    ...
                    <div class="social__items">
                        ...
                        <a href="" class="social__item"><svg class="icon"><use xlink:href="{{asset('images/dist/sprite.svg#telegram')}}"></use></svg></a>
                        <a href="" class="social__item"><svg class="icon"><use xlink:href="{{asset('images/dist/sprite.svg#facebook')}}"></use></svg></a>
                    </div>
                </div>
            </div>
