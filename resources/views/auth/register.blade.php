                    ...
                    <form id="registerForm" method="POST" action="{{ route('register.store') }}"
                        ...
                        <div class="form__fieldset">
                            <label class="checkbox">
                                ...
                                <div class="checkbox__text">Подпишитесь на рассылку новостей<br> <small>Установив этот
                                        флажок, вы соглашаетесь получать сообщения о запуске новых продуктов,
                                        эксклюзивных событиях в магазине и сезонных рекламных акциях.</small></div>
                            </label>
                        </div>
                        <div class="form__fieldset">
                            <label class="checkbox">
                                <input type="checkbox" name="agreement" value="1" required/>
                                <div class="checkbox__text">Я прочитал <a href="/pages/policy">Условия и положения</a> ,
                                    а также <a href="/pages/policy">Политику конфиденциальности</a> и согласен с ними*
                                </div>
                            </label>
                        </div>


                        <button type="submit" id="reg_btn" class="btn btn--accent">Зарегистрироваться</button>
                    </form>
