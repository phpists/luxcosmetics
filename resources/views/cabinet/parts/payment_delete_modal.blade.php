<div class="popupform mfp-hide" id="deletePayment" style="max-width: 640px">
    <div class="popupform__title">Вы дествительно хотите удалить способ оплаты?</div>
    <div class="addprod">
    ...
    <div class="popupform__btns">
        ...
        <form class="flex-fill" action="{{route('profile.payment-method.delete')}}" method="POST">
            @csrf
            @method('delete')
