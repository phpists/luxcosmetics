    ...
    <div class="review">
        ...
        <div class="review__footer">
            ...
            <div class="review__mark markblock">
                ...
                <button class="markblock__btn like_btn on_like_btn like_init @if($question->is_like === 1) checked @endif" data-value="1" data-table="product_questions" data-id="{{$question->id}}">
                    <svg class="icon">
                        <use xlink:href="{{asset('images/dist/sprite.svg#like')}}"></use>
                    </svg>
                    <span>{{$question->like}}</span>
                </button>
                <button class="markblock__btn like_btn dislike_btn like_init @if($question->is_like === 0) checked @endif" data-value="0" data-table="product_questions" data-id="{{$question->id}}">
                    <svg class="icon">
