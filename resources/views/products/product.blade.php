@extends('layouts.app')
@section('title', $metaTitle = $product->meta_title ?? getSeoTemplateTitle(\App\Enums\SeoTemplateEnum::PRODUCT, $product))
@section('description', $metaDescription = $product->description_meta ?? getSeoTemplateDescription(\App\Enums\SeoTemplateEnum::PRODUCT, $product))
@section('keywords', $product->keywords_meta ?? '')
@section('og:title', $product->og_title_meta ?? $metaTitle)
@section('og:description', $product->og_description_meta ?? $metaDescription)
