...
<section class="cart-page">
	<div class="container">
        ...
        <div class="cart-product__numbers">
                <div class="numbers">
                        <div class="numbers__minus minus"><svg class="icon"><use xlink:href="images/dist/sprite.svg#minus"></use></svg></div>
                        <input type="text" class="numbers__input" value="1">
                        <div class="numbers__plus plus"><svg class="icon"><use xlink:href="images/dist/sprite.svg#plus"></use></svg></div>
                </div>
        </div>
        <div class="cart-product__prices" data-title="Цена">
        ...
        <button class="cart-product__delete"><svg class="icon"><use xlink:href="images/dist/sprite.svg#close"></use></svg></button>
</div>
								<div class="cart-table__item cart-product">
        <div class="cart-product__image">
                <a href=""><img src="images/dist/tmp-product2.jpg" alt=""></a>
        ...
        <button class="cart-product__delete"><svg class="icon"><use xlink:href="images/dist/sprite.svg#close"></use></svg></button>
						...
						<div class="cart-page__giftbox">
							<h3 class="cart-page__subheading subheading"><svg class="icon"><use xlink:href="images/dist/sprite.svg#gift"></use></svg> Подарочная коробка</h3>
