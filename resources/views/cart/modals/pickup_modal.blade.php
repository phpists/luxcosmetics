            ...
            <div class="delivery_service">
                <button class="select-delivery-type">
                    ...
                    <div class="dropdown" id="post_offices">
                        ...
                        <div class="select-delivery-type-opt @if($loop->first) active @endif" data-value="{{ $deliveryMethod->id }}" data-name="{{ $deliveryMethod->name }}" data-type="{{ $deliveryMethod->title }}">
